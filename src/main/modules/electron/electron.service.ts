...
export class ElectronService implements OnModuleInit, OnApplicationBootstrap {
  ...
  public readonly APP_WIDTH = 1440
  public readonly APP_HEIGHT = 810
  ...
  public async createWindow() {
    return new Promise<void>(async resolve => {
      ...
      this.window = new BrowserWindow({
        ...
        kiosk: import.meta.env.PROD,
        autoHideMenuBar: import.meta.env.PROD,
        ...(process.platform === 'linux' ? { icon: this.ICON } : {}),
